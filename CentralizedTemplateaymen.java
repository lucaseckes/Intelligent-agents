...
//		System.out.println("Agent " + agent.id() + " has tasks " + tasks);
 ...
 // Linear-search function to find the index of an element 
    ...
    //NextTasks, findIndex(index, "v"+ Integer.toString(vehicles.get(k).id()+1)), "P"+Integer.toString(task_nb));
    	...
    	System.out.println("vehicles0 "+Arrays.toString(previous.vehicles));

    	System.out.println("vehicles "+Arrays.toString(new_vars.vehicles));

    	System.out.println("Next tasks1: "+Arrays.toString(previous.NextTasks));
    	System.out.println("Next tasks2: "+Arrays.toString(new_vars.NextTasks));
