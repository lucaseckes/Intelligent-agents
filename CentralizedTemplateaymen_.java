...
//		System.out.println("Agent " + agent.id() + " has tasks " + tasks);
        ...
        System.out.println("vars changed: "+Arrays.toString(vars.NextTasks));
        System.out.println("vars2: "+Arrays.toString(vars2.NextTasks));
        System.out.println("vars3: "+Arrays.toString(vars3.NextTasks));
    ...
    private Variables SelectInitialSolution(List<Vehicle> vehicles, TaskSet tasks) {
    	...
    	nextTasks[2*sz_t] = "P1";
    	System.out.println("Next tasks: "+Arrays.toString(nextTasks));
    	System.out.println("time: "+Arrays.toString(time));
    	System.out.println("vehicle: "+Arrays.toString(vehicle));
    ...
    { 
    	...
    	//return strs.contains(toCheckValue);
    ...
    { 
    	List<String> strs = Arrays.asList(arr);
    	strs.stream().filter(str -> str.equals(toCheckValue)).count();
